      ...
      <section className="w-full">
        {products.map((item) => (
          <div
            ...
            className={`transition-all duration-500 px-6 md:px-20 py-10 w-full flex flex-col md:flex-row items-center gap-10 md:gap-20 ${
          ...
          >
            ...
            {/* Text content */}
            <div
              className={`flex flex-col gap-3 max-w-3xl transition-colors duration-500 ${
